...
const phoneName = urlParamas.get("phone");
console.log(urlParamas.get("phone"));

let product = phoneObject.products.find((item) => item.name === phoneName);
console.log(product);
